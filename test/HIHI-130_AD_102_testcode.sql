...
# Unit test for encryption function
def test_encrypt_data():
    test_data = "test"
    encrypted_data = encrypt_data(test_data, encryption_key)
    assert encrypted_data is not None, "Encryption failed, result is None"
    assert isinstance(encrypted_data, str), "Encrypted data is not a string"
