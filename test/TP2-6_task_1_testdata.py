...
VALUES
  ('11', NULL, '2024-03-31T00:00:00.000+0000', 10.99, 5.0, ['tag1', 'tag2'], {'color': 'red', 'size': 'large'}),
  ('12', 'Product L', NULL, 9.99, 3.0, ['tag2', 'tag3'], {'color': 'blue', 'size': 'medium'}),
  ('13', 'Product M', '2024-04-01T00:00:00.000+0000', NULL, 2.0, ['tag1', 'tag3'], {'color': 'green', 'size': 'small'}),
  ('14', 'Product N', '2024-04-02T00:00:00.000+0000', 8.99, NULL, ['tag2', 'tag4'], {'color': 'yellow', 'size': 'large'}),
  ('15', 'Product O', '2024-04-03T00:00:00.000+0000', 11.99, 1.0, NULL, {'color': 'purple', 'size': 'medium'});

INSERT INTO purgo_playground.null_handling_test_data
VALUES
  (NULL, 'Product P', '2024-04-04T00:00:00.000+0000', 10.99, 5.0, ['tag1', 'tag2'], {'color': 'red', 'size': 'large'}),
  ('17', NULL, '2024-04-05T00:00:00.000+0000', 9.99, 3.0, ['tag2', 'tag3'], {'color': 'blue', 'size': 'medium'}),
  ('18', 'Product R', NULL, 12.99, 2.0, ['tag1', 'tag3'], {'color': 'green', 'size': 'small'}),
  ('19', 'Product S', '2024-04-07T00:00:00.000+0000', NULL, 4.0, ['tag2', 'tag4'], {'color': 'yellow', 'size': 'large'}),
  ('20', 'Product T', '2024-04-08T00:00:00.000+0000', 8.99, NULL, ['tag1', 'tag4'], {'color': 'purple', 'size': 'medium'});
